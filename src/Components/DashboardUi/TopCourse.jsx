    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between border-t-[1px] border-t-gray-200 py-4 px-6">
        <button
          ...
          className="px-4 py-2 mr-2 bg-white border-[1px] text-gray-700 rounded hover:bg-gray-300 disabled:opacity-50"
        >
          Previous
        </button>
        ...
        <button
          ...
          className="px-4 py-2 ml-2 bg-white border-[1px] text-gray-700 rounded hover:bg-gray-300 disabled:opacity-50"
        >
            <FaArrowRight />
          Next
        </button>
