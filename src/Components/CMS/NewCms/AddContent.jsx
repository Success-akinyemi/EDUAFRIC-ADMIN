...
function AddContent() {
  ...
  const [statusState, setStatusState] = useState(statusData[0]);
  ...
  return (
    <div className="relative card flex flex-col gap-[16px] rounded-none max-h-[1024px] overflow-y-auto border-[1px] border-white rounded-t-[12px] shadow-sm scrollbar-thin">
      ...
      {
        scheduleModal && (
          <ScheduleModal formData={formData} setFormData={setFormData} setScheduleModal={setScheduleModal} setErrorMsg={setErrorMsg} />
        )
      }
      {/* TOP */}
      ...
      <div className="flex">
        ...
        <div className="flex-[30] flex flex-col items-center px-5 gap-6">
          ...
          <div className="inputGroup">
            ...
            <select className="input" onChange={handleChange} id="accountType">
              <option value="">Select Type</option>
